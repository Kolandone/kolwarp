...
echo   %GREEN%1.%NC% Personal WARP
echo   %GREEN%2.%NC% ZeroTrust (requires JWT token)
echo   %DIM%Select [1-2]:%NC% 
set /p reg_type=

set "cmd=%KOLWARP_BIN% register"
...
set "cmd=%KOLWARP_BIN% %mode_cmd% %protocol_args% -b %bind_addr% -p %port%
